        ...
        <div className="space-y-6 text-neutral-400 leading-relaxed">
          ...
          <div className="pt-10 border-t border-white/10 text-center">
            ...
            <div className="mt-8 flex justify-center space-x-6">
               ...
               <a href="https://prajwalshelar-portfolio.vercel.app/" target="_blank" className="text-xs font-bold text-blue-400 hover:text-white transition-colors underline decoration-blue-500/30 underline-offset-4">Portfolio</a>
            </div>
          </div>
        </div>
      </div>
